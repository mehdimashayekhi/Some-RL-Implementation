...
def sample(env, 
    ...
    for i in range(num_paths):
        ...
        paths["acc_rewards"].append(sum(paths["rewards"][-ep_len:])) # this is return (accumulated reward)
...
def train(env, 
    ...
    onpol_iters                 Number of iterations of onpolicy aggregation for the loop to run.  # should be k in algo1?!
    ...
    paths = sample(env = env, controller = random_controller, num_paths=num_paths_random, horizon=env_horizon, verbose=False)
